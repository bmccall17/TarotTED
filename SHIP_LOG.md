...
- Starts with query: 75 points × field weight
- Word starts with query: 50 points × field weight
- Contains query: 25 points × field weight
...
| Phase 3 | UX polish & accessibility | ✅ Complete |
| Phase 4 | Performance optimizations | 🔮 Deferred (not needed at current scale) |
