...
TarotTALKS is a lookup instrument mapping 78 Tarot cards to TED talks. The application is built on a modern tech stack (Next.js 15, React 19, TypeScript, Drizzle ORM, Supabase) with a clean architecture. The core functionality is complete and working, with a full admin portal for content management.
