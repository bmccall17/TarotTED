...
First formal release of TarotTALKS - a fully functional web application mapping the 78-card Tarot deck to TED talks. This release marks the baseline before beginning admin portal development (v0.2.0).
