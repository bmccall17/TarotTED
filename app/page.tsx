      ...
      >
        ...
        <div className="text-center opacity-60 hover:opacity-100 transition-opacity duration-500">
          ...
          <p className="text-gray-500 text-xs leading-relaxed">
            Each tarot card is paired with <span style={{ fontFamily: 'Helvetica, Inter, Arial, sans-serif', fontWeight: 'bold', color: '#EB0028' }}><a href="https://www.ted.com/" target="_blank">TED</a></span> talks (and similar talks) that echo its wisdom.
