...
- **cards.ts** - All 78 Tarot cards (22 Major + 14 Wands)
- **cards-minor.ts** - Minor Arcana (Cups, Swords, Pentacles)
...
- **talkSlug**: References a talk (e.g., "stuart-brown-play-is-more-than-just-fun")
